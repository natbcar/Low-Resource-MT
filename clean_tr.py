...
md = {"tr": MosesDetokenizer(lang="tr"), "en": MosesDetokenizer(lang="en")}
...
def text_ratio(s):
    return len(
        re.findall(r"[AaBbCcÇçDdEeFfGgĞğHhIıİiJjKkLlMmNnOoÖöPpRrSsŞşTtUuÜüVvYyZz]", s)
    ) / len(s)
