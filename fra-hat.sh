...
FRHTOUT=/usr1/data/nrrobins/translation/onmt_corpora/fr-ht
# files: enfr_english  enfr_french  enht_english  enht_haitian
echo "BASE XPER'T %%%%%%"
python3 mt.py --out-dir $FRHTOUT --phon-type base --phon-pad zero --phon-gram 1 --src1 $FRHTDATA/enht_haitian --tgt1 $FRHTDATA/enht_english --src2 $FRHTDATA/enfr_french --tgt2 $FRHTDATA/enfr_english --src1_lang hat --src2_lang fra --tgt-lang eng --train1-len 15000 --train2-len 250000 --val-len 5000 --test-len 5000 --config-temp config_template --mod-dim 512 --train-steps 120000 --save-steps 30000 --val-steps 5000 --spm-vocab-size 8000
